// Testes de erros semanticos (arquivo deve falhar na compilacao)  OK!!

let int x = 10;

// ERRO: variavel nao declarada  OK
y = 5;

// ERRO: redeclaracao de variavel   OK
let int x = 20;

// ERRO: tipo incompativel na atribuicao OK
let str s = 42;

// ERRO: atribuicao em constante OK
const int c = 100;
c = 200;

// ERRO: break fora de loop  OK
break;

// ERRO: tipo incompativel em operacao  OK
let real r = 5.5;
let bool b = r + 10;
...
// Chamadas de funcoes com erro  OK!!!!!!!
