...
public class JSSLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LET", "CONST", "FUNCTION", "VOID", "IF", "ELSE", "WHILE", "FOR", "BREAK", 
			"RETURN", "CLASS", "CONSTRUCTOR", "NEW", "THIS", "TRUE", "FALSE", "NULL", 
			"INPUT", "CONSOLE_LOG", "TYPE_INT", "TYPE_REAL", "TYPE_STR", "TYPE_BOOL", 
			"REAL_LITERAL", "INTEGER_LITERAL", "STRING_LITERAL", "IDENTIFIER", "POWER_ASSIGN", 
			"POWER", "EQUAL_EQUAL", "BANG_EQUAL", "GREATER_EQUAL", "LESS_EQUAL", 
			"AND_AND", "OR_OR", "PLUS_PLUS", "MINUS_MINUS", "PLUS_ASSIGN", "MINUS_ASSIGN", 
			"STAR_ASSIGN", "SLASH_ASSIGN", "PERCENT_ASSIGN", "ASSIGN", "PLUS", "MINUS", 
	...
	public JSSLexer(CharStream input) {
		super(input);
